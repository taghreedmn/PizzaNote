           ...
           <div class="page-utilities">
            ...
            <div class="d-grid  p-1 col-md-auto col-sm-12 order-3 btn-responsive">
              <?php if (chk_para(session("user_info")["ui_para"],$menu_active."_add")=="ok" or session("user_info")["ui_type"]=="1"){ ?>
                <a class="btn btn-primary btn-responsive" data-bs-toggle="modal" data-remote="{{ route('pizza.create') }}"  data-bs-target="#modal-add"><i class="fas fa-plus"></i>
            ...
            <?php } ?>
              ...
              <?php if (chk_para(session("user_info")["ui_para"],$menu_active."_rep")=="ok" or session("user_info")["ui_type"]=="1"){ ?>
                <a class="btn btn-success btn-responsive" data-bs-toggle="modal" data-remote="{{ route('pizza.rep') }}"  data-bs-target="#modal-rep"><i class="far fa-file-alt"></i> <b>التقارير</b></a>
              <?php } ?>
              </div>
    ...
    @foreach ($listings as $list)
      ...
      <td class="cell">
          <a class="btn btn-success" data-bs-toggle="modal"
              data-remote="{{ route('pizza.show', enc($list->id) ) }}"
		 ...
		 <td class="cell">
        <?php echo get_my_p_size($list->my_p_size); ?>
     </td>
		<td class="cell"> 
      <?php echo show_my_p_toppings($list->my_p_toppings);?>
    </td>
		<td class="cell">
      <?php echo get_my_p_type($list->my_p_type); ?>
    </td>
		<td class="cell">
      <?php echo $list->my_p_price; ?>
    </td>
		<td class="cell">
      <?php echo $list->my_p_name; ?>
    </td>
		<td class="cell">
      <?php echo $list->my_p_add_date; ?>
    </td>
		<td class="cell">
      <?php echo $list->id; ?>
    </td>
