              ...
              <table class="table app-table-hover mb-0  table-striped table-bordered text-center" data-toggle="table" id="datat_ex">
                <thead>
                  <tr class="bg-infox">    
     					      ...
     					      <th class="text-center" width="%" data-visible="true">الحجم</th>
     					      <th class="text-center" width="%" data-visible="true">الإضافات</th>
     					      <th class="text-center" width="%" data-visible="true">النوع</th>
     					      <th class="text-center" width="%" data-visible="true">السعر</th>
                ...
                @foreach ($listings as $key => $list)
                			...
                			<td><?php echo get_my_p_size($list->my_p_size); ?></td>
                			<td> <?php echo show_my_p_toppings($list->my_p_toppings);?></td>
                			<td><?php echo get_my_p_type($list->my_p_type); ?></td>
                			<td><?php echo $list->my_p_price; ?></td>
                			<td><?php echo $list->my_p_name; ?></td>
                			<td><?php echo $list->my_p_add_date; ?></td>
